...
<head>
    ...
    <script src="<c:url value="/jsdb/dcTrip.js"/> " language="JavaScript"></script></head>
<body>
...
<table>
    ...
    <c:forEach var="oo" items="${dcTrip}">
        <tr>
        <td><input class="ooid" value="${oo.id}" readonly="true" /></td>
        <td><input class="ootripTime" value="${oo.tripTime}" /></td>
