...
<head>
    ...
    <script src="<c:url value="/jsdb/commSuggestion.js"/> " language="JavaScript"></script></head>
<body>
...
<table>
    ...
    <c:forEach var="oo" items="${commSuggestion}">
        <tr>
        <td><input class="ooid" value="${oo.id}" readonly="true" /></td>
        <td><input class="oouserId" value="${oo.userId}" /></td>
        <td><input class="oocontactWay" value="${oo.contactWay}" /></td>
        <td><input class="oosugContent" value="${oo.sugContent}" /></td>
